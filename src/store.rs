...
impl Store {
    ...
    pub async fn update_question(&self, question: Question, question_id: i32, account_id: AccountId)
    ...
    pub async fn delete_question(&self, question_id: i32, account_id: AccountId) -> Result<bool, Error> {
    ...
    pub async fn is_question_owner(&self, question_id: i32, account_id: &AccountId) -> Result<bool, Error> {
